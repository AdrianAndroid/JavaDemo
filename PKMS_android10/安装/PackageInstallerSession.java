...
public class PackageInstallerSession extends IPackageInstallerSession.Stub {
     ...
     */
    private @Nullable
    List<PackageInstallerSession> getChildSessions() {
    ...
    private void commitNonStagedLocked(List<PackageInstallerSession> childSessions)
        ...
        if (isMultiPackage()) {
            ...
            for (int i = 0; i < childSessions.size(); ++i) {
                ...
                try {
                    final PackageManagerService.ActiveInstallSession activeSession = session.makeSessionActiveLocked();
            ...
            if (!success) {
                try {
                    mRemoteObserver.onPackageInstalled(null, failure.error, failure.getLocalizedMessage(), null);
                } catch (RemoteException ignored) {
                }
                return;
            }
